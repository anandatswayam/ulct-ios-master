...
//
//  SpecialDistrictsListViewController.m
//  ultc
//
...
@interface SpecialDistrictsListViewController ()

@end

@implementation SpecialDistrictsListViewController
...
- (void)viewDidLoad
{
    ...
    FMResultSet * s = [ db executeQuery:@"SELECT id, name FROM special_districts ORDER BY name"];
    while ([s next]) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    SpecialDistrictViewController * vc = [[SpecialDistrictViewController alloc] init];
