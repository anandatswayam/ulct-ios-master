//
//  StateAgenciesListViewController.m
//  ultc
//
...
@interface StateAgenciesListViewController ()

@end

@implementation StateAgenciesListViewController
...
- (void)viewDidLoad
{
    ...
    FMResultSet * s = [ db executeQuery:@"SELECT id, name FROM state_agencies ORDER BY name"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    StateAgencyViewController * vc = [[StateAgencyViewController alloc] init];
