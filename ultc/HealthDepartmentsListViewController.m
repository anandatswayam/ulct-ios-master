//
//  HealthDepartmentsListViewController.m
//  ultc
//
...
@interface HealthDepartmentsListViewController ()

@end

@implementation HealthDepartmentsListViewController
...
- (void)viewDidLoad
{
    ...
    FMResultSet * s = [ db executeQuery:@"SELECT id, name FROM health_depts ORDER BY name"];
    while ([s next]) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    HealthDepartmentViewController * vc = [[HealthDepartmentViewController alloc] init];
