...
@interface BoardMembersViewController ()

@end

@implementation BoardMembersViewController
...
- (void)viewDidLoad
{
    ...
    FMResultSet * s = [ db executeQuery:@"SELECT id, name FROM ulct_board_members ORDER BY name"];
    while ([s next]) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    BoardMemberViewController * vc = [[BoardMemberViewController alloc] init];
