//
//  AssociationsListViewController.m
//  ultc
//
...
@interface AssociationsListViewController ()

@end

@implementation AssociationsListViewController
...
- (void)viewDidLoad
{
    ...
    FMResultSet * s = [ db executeQuery:@"SELECT id, name FROM associations ORDER BY name"];
    while ([s next]) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    AssociationViewController * vc = [[AssociationViewController alloc] init];
