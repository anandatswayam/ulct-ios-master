//
//  GeneralInfoUsHouseViewController.m
//  ultc
//
...
@interface GeneralInfoUsHouseViewController ()
...
@implementation GeneralInfoUsHouseViewController
...
- (void)viewDidLoad
{
    ...
    if([s next]){
        ...
        NSArray * textFields = @[@"us_house_address",
                                 @"us_house_city",
                                 @"us_house_state",
                                 @"us_house_zip",
                                 @"us_house_phone",
        ...
        if( ! [(NSString *) [self.dict objectForKey:@"us_house_address"] isEqual:@""] || ! [(NSString *) [self.dict objectForKey:@"us_house_city"] isEqual:@""] ) {
            [self.fieldOrder addObject:@"map"];
            [self.fieldOrder addObject:@"us_house_address"];
        }
        
        if( ! [(NSString *) [self.dict objectForKey:@"us_house_phone"] isEqual:@""] ) {
            [self.fieldOrder addObject:@"us_house_phone"];
        }
        
        if( ! [(NSString *) [self.dict objectForKey:@"us_house_fax"] isEqual:@""] ) {
            [self.fieldOrder addObject:@"us_house_fax"];
        }
...
-(NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    return (int)[self.fieldOrder count];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if([field isEqual:@"map"]){
        ...
        NSString * address = [NSString stringWithFormat:@"%@, %@, %@ %@",
                              [self.dict objectForKey:@"us_house_address"],
                              [self.dict objectForKey:@"us_house_city"],
                              [self.dict objectForKey:@"us_house_state"],
                              [self.dict objectForKey:@"us_house_zip"]
                              ];
    ...
    } else if([field isEqual:@"us_house_address"]){
        ...
        addressCell.addressLine1.text = [self.dict objectForKey:@"us_house_address"];
    ...
    else if([field isEqual:@"us_house_phone"]){
        ...
        singleCell.content.text = [self.dict objectForKey:@"us_house_phone"];
        cell=singleCell;
        
    } else if([field isEqual:@"us_house_fax"]){
        SingleLineTableViewCell * singleCell = [WRUtilities getViewFromNib:@"SingleLineTableViewCell" class:[SingleLineTableViewCell class]];
        singleCell.title.text = @"Fax:";
        singleCell.content.text = [self.dict objectForKey:@"us_house_fax"];
        cell=singleCell;
