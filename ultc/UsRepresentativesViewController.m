//
//  UsRepresentativesViewController.m
//  ultc
//
...
@interface UsRepresentativesViewController ()

@end

@implementation UsRepresentativesViewController
...
- (void)viewDidLoad
{
    ...
    FMResultSet * s = [ db executeQuery:@"SELECT id, name FROM congressmen where type = \"us_rep\" ORDER BY name"];
    while ([s next]) {
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UsRepresentativeViewController * vc = [[UsRepresentativeViewController alloc] init];
